...
**Symptoms**: Running `mcp-consultant` shows "command not found"
...
2. Test server manually:
   ...
   ```bash
   OPENAI_API_KEY=sk-your-key npx -y mcp-consultant
   ```
...
```bash
# Logs to stderr
OPENAI_API_KEY=sk-key npx -y mcp-consultant 2> debug.log
```
...
Search existing issues: [github.com/amsv01/mcp-consultant/issues](https://github.com/amsv01/mcp-consultant/issues)
...
- Package version: `npx -y mcp-consultant --version`
- Operating system
...
Create a new issue: [github.com/amsv01/mcp-consultant/issues/new](https://github.com/amsv01/mcp-consultant/issues/new)
...
- GitHub Discussions
- Stack Overflow (tag: mcp-consultant)
